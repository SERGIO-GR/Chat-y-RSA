...
import chatapp.net.MessageListener;
import chatapp.net.MessageTransmitter;
import chatapp.net.WriteableGUI;
...
public class mainChat extends javax.swing.JFrame implements WriteableGUI {
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if (PublicKeySent == true) {
            ...
            transmitter.start();
            PublicKeySent = true;
            write("se enviaron las claves a su destinatario, vuelva a escribir su mensaje.");
        }
