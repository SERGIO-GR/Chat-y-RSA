        ...
        try {
            while ((clientSocket = server.accept()) != null) { //Keeps accepting connection to the server
                ...
                if (keyRecieved == true) {
                    ...
                    if (line != null) {
                        gui.write("Mensaje encriptado recibido: '" + encryptedMessage + "'.. Desencriptando");
                        gui.write("El -->" + decryptedMsg);
                    }
                } else {
                    // Get the data!!!
                    BufferedReader br = new BufferedReader(new InputStreamReader(is));
                    ...
                    gui.write("llave publica : " + this.publicKey.toString());
                    gui.write(" modulo: " + this.modulus.toString());
                    keyRecieved = true;
                }
            }
        } catch (IOException ex) {
